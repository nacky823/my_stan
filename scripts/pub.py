...
def main():
    ...
    #while True:
        ...
        pub.publish(mouth_coordinate)

        #rospy.loginfo("Message '{}' published".format(msg_str))
        rospy.loginfo(mouth_coordinate)

        # 1 秒スリープする
        #rate.sleep()
        rospy.sleep(0.05) # 0.05
...
def draw_landmarks(image, landmarks):
    ...
    if len(landmark_point) > 0:
        ...
        mouth_coordinate.x = current_point.x
        mouth_coordinate.y = current_point.y
        mouth_coordinate.z = current_point.z
